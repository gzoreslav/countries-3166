...
document.getElementById('ukr-a2').onclick = function () {
    ...
    _index2.default.init();
    console.log(_index2.default.translate('UKR').alpha2().toArray());
};

document.getElementById('ru-a2-array').onclick = function () {
    console.info('=== alpha-2 / translated / object ===');
    _index2.default.init();
    console.log(_index2.default.translate('RU').alpha2().values());
};
...
},{"./ru.js":8,"./ua.js":9}],8:[function(require,module,exports){
'use strict';
