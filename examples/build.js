...
document.getElementById('default').onclick = function () {
    ...
    console.log(_index2.default.values());
};

document.getElementById('array').onclick = function () {
    console.info('=== alpha-3 / array ===');
    _index2.default.init();
    console.log(_index2.default.toArray());
};

document.getElementById('a2').onclick = function () {
    console.info('=== alpha-2 / object ===');
    _index2.default.init();
    console.log(_index2.default.alpha2().values());
};

document.getElementById('a2-array').onclick = function () {
    console.info('=== alpha-2 / array ===');
    _index2.default.init();
    console.log(_index2.default.alpha2().toArray());
};

//translation

document.getElementById('ukr').onclick = function () {
    console.info('=== alpha-3 / translated / object ===');
    _index2.default.init();
    console.log(_index2.default.translate('UKR').values());
};

document.getElementById('ukr-a2').onclick = function () {
    console.info('=== alpha-2 / translated / array ===');
    _index2.default.init();
    console.log(_index2.default.translate('ua').alpha2().toArray());
};
...
var _alpha2 = require('./alpha2.js');

var _alpha3 = _interopRequireDefault(_alpha2);

var _index = require('./translation/index.js');
...
var Countries = function () {
    function Countries() {
        ...
        this.data = _lodash2.default.cloneDeep(_data2.default);
    }
    ...
    _createClass(Countries, [{
        ...
        value: function translate(lang) {
            ...
            var transl = _index2.default[lang.length == 2 ? lang : _alpha3.default[lang]] || null;
            if (!transl) return this;
            this.data = _lodash2.default.mapValues(this.data, function (value, key) {
                return key.length === 3 ? transl[_alpha3.default[key]] || value : transl[key] || value;
            });
            return this;
        }
    }, {
...
},{"./alpha2.js":4,"./data.js":5,"./translation/index.js":7,"lodash":2}],7:[function(require,module,exports){
'use strict';
...
},{"./ua.js":8}],8:[function(require,module,exports){
'use strict';
